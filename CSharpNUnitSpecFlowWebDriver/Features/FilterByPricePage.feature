...
Scenario Outline: FilterByPrice
	...
	And I click filter search results by price and select <minprice> and <maxprice> to filter by
	Then I should be able to see search results between <minprice> and <maxprice> in the first result
Examples:
